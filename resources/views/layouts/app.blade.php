                         ...
                         <li><a href="{{ url('/aboutus') }}"  style="color: black;" id="nav_link">About Us</a></li>
                            ...
                            <li class="dropdown">
                                ...
                                <ul class="dropdown-menu" role="menu"> 
                                    @if(count($category)>0)
                                    @foreach($category as $categ)
                                   <li style="border-bottom: 1px solid #990099;">
                                     <a href="{{url('customer/view_products/categ/ ')}}{{$categ->id}}" style="">{{$categ->category_name }}</a>
                                   </li>
                                   <br>
                                    @endforeach
                            ...
                            <li><a href="{{ route('vendor.sell') }}" style="color: white;">Sell</a></li>
                             <li><a href="{{ route('product.shopingcart') }}" style="color: black;"><i class="fa fa-cart-plus" aria-hidden="true"></i>
Your Cart (<span class="badge" style="color: red;background-color: #990099;"> {{Session::has('cart') ? Session::get('cart')->total_quantity : 0}} </span>)</a></li>
                            <li class="dropdown">
                                ...
                                <ul class="dropdown-menu" role="menu" >
                                  <li style="border-bottom: 1px solid #990099;padding-bottom: 6%;"><a href="">Purchase History</a></li>
