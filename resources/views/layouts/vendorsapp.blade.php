...
color: black;
    ...
    .carousel-indicators .active {background-color: #990099;
}
    </style>
...
<body>
    <div id="container-fluid" style="height: auto;">
        <nav class="navbar navbar-default navbar-static-top" style="background-color: #990099; font-weight: bold;">
                    ...
                    <ul class="nav navbar-nav navbar-right">
                        ...
                        @if (Auth::guest())
                            ...
                            <li class="dropdown">
                              ...
                              <li><a href="{{ route('vendor.sell') }}" style="color: white;">Sell</a></li>
                               
                             <li><a href="{{ route('product.shopingcart') }}" style="color: black;"><i class="fa fa-cart-plus" aria-hidden="true"></i>
Your Cart (<span class="badge" style="color: red;background-color: #9933ff;"> {{Session::has('cart') ? Session::get('cart')->total_quantity : 0}} </span>)</a></li>
...
Your Cart (<span class="badge" style="color: red;background-color: #9933ff;"> {{Session::has('cart') ? Session::get('cart')->total_quantity : 0}} </span>)</a></li>
                            <li class="dropdown">
                                ...
                                <ul class="dropdown-menu" role="menu" >
                                  <li style="border-bottom: 1px solid #9933ff;padding-bottom: 6%;"><a href="">Purchase History</a></li>
    ...
    <div class="container-fluid" style="border: solid 1px #9933ff;">
      @yield('content') 
    </div> 
