    ...
    <div class="row">
        <div class="col-md-2">
            <div class="panel panel-default">
                ...
                <div id="side_links" style="border-bottom: 1px solid #990099">
                <h5>Admin Home</h5>
                <div>
            ...
            <div class="col-md-12 col-md-offset-5">
                <a href="/admin/addproduct" class="btn btn-default" style="background-color: #990099; color: black;" >Add product</a>
                <a href="/admin/home" class="btn btn-default" style="background-color: #990099; color: black;">Exit</a>
            </div>
        </div>
        </div>
</div>
...
@section('footer')
<div class="footer">
    <div class="container-fluid" style=" color: black; background-color: #990099;position: absolute; right: 0;
  bottom: 0;
  left: 0;
  padding: 1rem;">
    <div class="row">
